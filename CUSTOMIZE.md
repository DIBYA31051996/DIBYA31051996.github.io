...
- `authornote` (recommended) / `author_info`: Adds an optional author note line below the author list (for equal contribution, corresponding author, consortium notes, etc.)
